  ...
  context 'as authorized user' do
    ...
    context 'muliple discussions' do
      ...
      it 'shows jump to next discussion button except on last discussion' do
        ...
        expect(all_discussion_replies.size).to eq(2)
        expect(all_discussion_replies.first.all('.discussion-next-btn').size).to eq(1)
        expect(all_discussion_replies.last.all('.discussion-next-btn').size).to eq(0)
      end
