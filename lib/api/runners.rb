  ...
  class Runners < Grape::API
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      delete ':id/runners/:runner_id' do
        ...
        forbidden!("Only one project associated with the runner. Please remove the runner instead") if runner.projects.size == 1
    ...
    helpers do
      ...
      def authenticate_delete_runner!(runner)
        ...
        forbidden!("Runner associated with more than one project") if runner.projects.size > 1
