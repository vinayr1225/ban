...
Branch protection specifies which roles can push to branches, and delete branches.
...
HTTP(s) protocol will be allowed for Git clone/fetch requests done by GitLab Runner from CI/CD
Jobs, even if _Only SSH_ was selected.
